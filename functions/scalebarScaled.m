function h = scalebarScaled(varargin)
...
%     line(ends(:,1,2), ends(:,2,2), 'color', colour, 'linewidth', linewidth, 'parent', hg);
    ...
    text(linepos(2,1),0.99*linepos(2,2),0,num2sci(scalelength*units, 'm'),'verticalalignment',textalignment{1},'horizontalalignment',textalignment{2}, 'color', colour, 'fontweight', fontweight, 'fontsize', 22, 'parent', hg);
